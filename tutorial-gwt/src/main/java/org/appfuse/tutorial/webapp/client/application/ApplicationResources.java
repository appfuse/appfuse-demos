 ...
 * 	'tutorial-gwt/src/main/resources/org/appfuse/tutorial/webapp/client/application/ApplicationResources.properties'.
 */
public interface ApplicationResources extends com.google.gwt.i18n.client.Messages {
  ...
  /**
   * Translated "Forgot your password?  Have your <a href=\"?\" title=\"Have your password hint sent to you.\" id=\"passwordHint\">password hint e-mailed to you</a>.".
   * 
   * @return translated "Forgot your password?  Have your <a href=\"?\" title=\"Have your password hint sent to you.\" id=\"passwordHint\">password hint e-mailed to you</a>."
   */
  @DefaultMessage("Forgot your password?  Have your <a href=\"?\" title=\"Have your password hint sent to you.\" id=\"passwordHint\">password hint e-mailed to you</a>.")
  @Key("login.passwordHint.new")
  String login_passwordHint_new();
  ...
  /**
   * Translated "View People".
   * 
   * @return translated "View People"
   */
  @DefaultMessage("View People")
  @Key("menu.viewPeople")
  String menu_viewPeople();
  ...
  /**
   * Translated "Person has been added successfully.".
   * 
   * @return translated "Person has been added successfully."
   */
  @DefaultMessage("Person has been added successfully.")
  @Key("person.added")
  String person_added();

  /**
   * Translated "Person has been deleted successfully.".
   * 
   * @return translated "Person has been deleted successfully."
   */
  @DefaultMessage("Person has been deleted successfully.")
  @Key("person.deleted")
  ...
  /**
   * Translated "Person has been updated successfully.".
   * 
   * @return translated "Person has been updated successfully."
   */
  @DefaultMessage("Person has been updated successfully.")
  @Key("person.updated")
  String person_updated();

  /**
   * Translated "Person Information".
   * 
   * @return translated "Person Information"
   */
  @DefaultMessage("Person Information")
  @Key("personDetail.heading")
  String personDetail_heading();

  /**
   * Translated "Person Detail".
   * 
   * @return translated "Person Detail"
   */
  @DefaultMessage("Person Detail")
  @Key("personDetail.title")
  String personDetail_title();
  ...
  @Key("personList.heading")
  String personList_heading();
  ...
  @Key("personList.persons")
  String personList_persons();

  /**
   * Translated "Person List".
   * 
   * @return translated "Person List"
   */
  @DefaultMessage("Person List")
  @Key("personList.title")
  String personList_title();
  ...
  /**
   * Translated "Request a <a href=\"?\" id=\"passwordReset\">password reset</a> e-mailed to you.".
   * 
   * @return translated "Request a <a href=\"?\" id=\"passwordReset\">password reset</a> e-mailed to you."
   */
  @DefaultMessage("Request a <a href=\"?\" id=\"passwordReset\">password reset</a> e-mailed to you.")
  @Key("updatePassword.requestRecoveryTokenLink.new")
  String updatePassword_requestRecoveryTokenLink_new();
