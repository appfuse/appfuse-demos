...
import org.appfuse.tutorial.webapp.client.application.ApplicationActivityMapper;
import org.appfuse.tutorial.webapp.client.application.ApplicationPlaceHistoryFactory;
import org.appfuse.tutorial.webapp.client.application.ApplicationPlaceHistoryMapper;
import org.appfuse.tutorial.webapp.client.application.ApplicationProxyFactory;
import org.appfuse.tutorial.webapp.client.application.DesktopApplication;
import org.appfuse.tutorial.webapp.client.application.base.request.EventSourceRequestTransport;
import org.appfuse.tutorial.webapp.client.requests.ApplicationRequestFactory;
import org.appfuse.tutorial.webapp.client.ui.home.HomeActivity;
import org.appfuse.tutorial.webapp.client.ui.home.HomeView;
import org.appfuse.tutorial.webapp.client.ui.home.HomeViewDesktop;
import org.appfuse.tutorial.webapp.client.ui.login.LoginActivity;
...
import org.appfuse.tutorial.webapp.client.ui.people.edit.EditPersonView;
import org.appfuse.tutorial.webapp.client.ui.people.edit.EditPersonViewImpl;
...
import org.appfuse.tutorial.webapp.client.ui.upload.views.FileUploadViewImpl;
import org.appfuse.tutorial.webapp.client.ui.upload.views.UploadedFileView;
import org.appfuse.tutorial.webapp.client.ui.upload.views.UploadedFileViewImpl;
import org.appfuse.tutorial.webapp.client.ui.users.active.ActiveUsersActivity;
import org.appfuse.tutorial.webapp.client.ui.users.active.ActiveUsersView;
import org.appfuse.tutorial.webapp.client.ui.users.active.ActiveUsersViewImpl;
import org.appfuse.tutorial.webapp.client.ui.users.editProfile.EditProfileActivity;
import org.appfuse.tutorial.webapp.client.ui.users.editProfile.EditProfileView;
import org.appfuse.tutorial.webapp.client.ui.users.editProfile.EditProfileViewImpl;
import org.appfuse.tutorial.webapp.client.ui.users.editUser.EditUserActivity;
import org.appfuse.tutorial.webapp.client.ui.users.editUser.EditUserView;
import org.appfuse.tutorial.webapp.client.ui.users.editUser.EditUserViewImpl;
import org.appfuse.tutorial.webapp.client.ui.users.search.UsersSearchActivity;
import org.appfuse.tutorial.webapp.client.ui.users.search.UsersSearchView;
import org.appfuse.tutorial.webapp.client.ui.users.search.UsersSearchViewImpl;
import org.appfuse.tutorial.webapp.client.ui.users.signUp.SignUpActivity;
import org.appfuse.tutorial.webapp.client.ui.users.signUp.SignUpView;
import org.appfuse.tutorial.webapp.client.ui.users.signUp.SignUpViewImpl;
import org.appfuse.tutorial.webapp.client.ui.users.updatePassword.UpdatePasswordView;
import org.appfuse.tutorial.webapp.client.ui.users.updatePassword.UpdatePasswordViewImpl;
...
public class ClientGinModule extends AbstractGinModule {
    ...
    protected void configure() {
        ...
        bind(EditPersonView.class).to(EditPersonViewImpl.class).in(Singleton.class);
    }
